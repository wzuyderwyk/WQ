...
WQ.prototype = {
  ...
  $x_states: new Array(
    ...
    function (acc,newValue) { return parseInt(acc) * parseInt(newValue); },
    function (expression) { if(expression !== null) alert(expression); return expression; },
    ...
    function (string, newStateNotEvaluation) { return $x_states[3](string.substr(1,-1), newStateNotEvaluation); }
  ),
  ...
  determineType: function (tokenString) { // Types: 0=false, 1=true, 2=integer, 3=string, 4=floating-point number
    ...
    if (tokenString[0] === "\"" && tokenString[tokenString.length - 1] === "\"") { this.currentTypes.push(3); return tokenString; }
  ...
  determineStateAndIdentifierLength: function (currentState, currentlyParsedSerialisation) {
    ...
    this.identifiers.forEach(function (identifier,index) { if(identifier === candidateIdentifier) state = (new WQ).identifierAssociatedStates[index](identifier,currentState,this); }, this);
  ...
  identifierAssociatedStates: [
    ...
    function (identifier,currentState) { return 2; },
    function (identifier,currentState) { return 1; },
    function (identifier,currentState, thisArg) { return ((thisArg.currentTypes && thisArg.currentTypes.length === 1 && thisArg.currentTypes[0] === 3)?6:3); },
  ...
  test: function () {
    ...
    ),say(*(z,8)),say(\"natural language = undefined\")"); } catch(ex) { console.log(ex.message); }
