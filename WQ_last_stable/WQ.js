...
Webkist GeneriQual (experimental: element(), replace() and attach())
...
NEW BRANCH; NO LOGICAL-AND, -OR OR -LOOP FUNCTION IMPLEMENTED
TYPE-CHECKING NEEDS UPDATE FROM OTHER BRANCH, BUT IS PRETTY MUCH IN ORDER (NO NEED REALLY)

@author: Wietse Zuyderwyk */

var WQElements = function () { this.init(); }

WQElements.global = this;
